...
module.exports = {
  ...
  onStart: async function ({ api, args, message, event }) {
    ...
    if (!allmodels.includes(modelName)) {
      return message.reply(`╭── Ი𐑼 𖹭 𝖾𝗋𝗋𝗈𝗋 𖹭 Ი𐑼 ──╮\n\n  ᯓ★ 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝗆𝗈𝖽𝖾𝗅 𝗇𝖺𝗆𝖾 .ᐟ\n\n╰── ᯓ★˙𐃷˙݁ ˖Ი𐑼⋆𖹭.ᐟ ──╯`);
    }
    ...
    try {
      ...
      return message.reply({ body: `╭── Ი𐑼 𖹭 𝗏𝗈𝗂𝖼𝖾 𝗋𝖾𝖺𝖽𝗒 𖹭 Ი𐑼 ──╮\n\n  ⋆ 𝗆𝗈𝖽𝖾𝗅: ${modelName}\n  ⋆ 𝗅𝖺𝗇𝗀: ${lang}\n\n╰── ᯓ★˙𐃷˙݁ ˖Ი𐑼⋆𖹭.ᐟ ──╯`, attachment: stream });
    } catch (err) {
