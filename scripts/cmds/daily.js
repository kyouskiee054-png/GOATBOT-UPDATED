...
module.exports = {
    ...
    onStart: async function ({ event, envCommands, usersData, api, message }) {
        ...
        try {
            ...
            const cardUrl = `https://maybexenos.vercel.app/wlc-card/welcomecard?background=${encodeURIComponent(randomBG)}&avatar=${encodeURIComponent(avatarURL)}&text1=${encodeURIComponent(userName)}&text2=CLAIM+${currentCount}/5&text3=%2B${getCoin}+COIN`;
